...
## 標準出力とか標準エラー出力とか出力ってどういうこと？

- writeシステムコールでFDにデータを書き込むこと
  - FDはカーネル内部のファイルテーブルのインデックス
  - 0: 標準入力, 1: 標準出力, 2: 標準エラー出力と決まっている
- もっと踏み込むと、ターミナルもファイル扱いとされていて、そのファイルにデータを書き込むことで標準出力等が実現される
